...
def scale_image(image, scale, size=16):
    return pygame.transform.scale(image, (image.get_size()[0] * scale * size / Player_stats.tile_size, image.get_size()[1] * scale * size / Player_stats.tile_size))
...
DialogWindow.set_dialog_text("set_person1(player_icon)", "show_person1", "Что ж. Сегодня мне надо в цирк", "Таааак...", "...", "Чёрт. не помню дорогу.", "Ладно. Прогуляюсь немного.", "hide_person1")
dialog_menu.open()
