...
player_menu.add_option_panel(start_panel_name, "optionPanel1", 1320, 0, None, ("inventory", "open_panel", inventory_name))

player_menu.add_inventory_panel(inventory_name, "optionPanel1", 1320, 0, start_panel_name)
player_menu.add_item_actions_panel("item_actions", "itemActions", 1320 - 400, 0, inventory_name)

player_menu.add_text_panel("itemText", "textPanel1", 656, 296, "item_actions", item_text)


dialog_menu.add_dialog_window("Dialog window", "textPanel1", 200, 1080 - 404, None)
